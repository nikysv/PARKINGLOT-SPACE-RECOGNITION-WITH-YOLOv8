...
model = YOLO('yolov8n.pt')  # Puedes cambiar a yolov8m.pt o yolov8l.pt para modelos más grandes

# Obtener el directorio del script actual
script_dir = os.path.dirname(os.path.abspath(__file__))

# Rutas para los archivos de posiciones y estado de espacios
car_park_pos_filename = os.path.join(script_dir, 'CarParkPos')  # Archivo con coordenadas de los espacios
